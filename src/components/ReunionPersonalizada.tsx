...
const ReunionPersonalizada = () => {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4 mb-[-60px] mt-[10px]">
            <div className="flex justify-center gap-x-12 text-left max-w-7xl">
                <div className="max-w-sm border-r border-[#cccfd8] pr-[40px] h-full min-h-[600px]">
